...
<footer class="section-footer bg-secondary">
	<div class="container">
		...
		<section class="footer-bottom row border-top-white">
			<div class="col-sm-12">
				<p class="text-white-50"> Copyright &copy {{ Date('Y') }} <a href="#" class="text-white-50">Ganzberg Cambodia</a></p>
			</div>
      {{--}}
			<div class="col-sm-6">
				<p class="text-md-right text-white-50">
	Copyright &copy {{ Date('Y') }} <br>
<a href="#" class="text-white-50">Ganzberge Cambodia</a>
				</p>
			</div>
      --}}
		</section> <!-- //footer-top -->
